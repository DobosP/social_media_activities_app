        ...
        migrations.AlterField(
            ...
            field=models.CharField(
                choices=[
                    ...
                    ("mention", "Mention"),
                    ("organizer_role", "Organizer role changed"),
                    ("activity_match", "Saved-search match"),
                    ("gauge_match", "Saved-search gauge match"),
                    ("group_question", "Group question"),
                    ("interest_converted", "Gauge converted"),
                    ("rsvp_nudge", "RSVP nudge"),
                    ("organizer_prep", "Organizer prep reminder"),
