...
not). This processor reads + validates them for EVERY request and exposes the allowlisted values
that base.html stamps onto <html> (data-theme / data-text / data-motion). An unset or tampered
cookie falls back to a safe default ("auto" → honour the OS preference)."""
